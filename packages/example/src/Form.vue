            ...
            <Form ref="showcaseFormRef" :model="formDemoModel" :rules="formDemoRules" label-width="112px" item-gap="18px" @validate="handleFormValidate" @submit.prevent="submitShowcaseForm">
              ...
              <div class="grid min-w-0 items-start gap-x-5 xl:grid-cols-2">
                ...
                <FormItem prop="domain" label="官网">
                  <Input v-model="formDemoModel.domain" placeholder="https://unoui.local" clearable prefix-icon="i-lucide:globe-2" />
                </FormItem>
                <FormItem
                  prop="color"
                  label="主题色"
...
import { formProps, formEmits, formSlots, formItemProps, formItemSlots, formRuleColumns, formRuleFields, formTypeColumns, formTypes, formCodeExample } from '@/data/form'
...
const formDemoModel = ref({
  name: '华东旗舰项目',
  email: 'admin@unoui.local',
  phone: '13800138000',
  projectId: 'demo_project-01',
  domain: 'https://unoui.local',
  color: '#2563eb',
  themeColor: {
    mode: 'solid',
    color: '#2563eb',
