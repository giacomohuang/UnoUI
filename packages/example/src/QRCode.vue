    ...
    <div class="grid gap-5 p-4 text-sm text-secondary">
      <div class="grid gap-2 md:grid-cols-[88px_minmax(0,1fr)] md:items-center">
        ...
        <div class="flex flex-wrap items-center gap-4 rounded-md bg-secondary/60 px-3 py-4">
          <QRCode value="https://vmap.example.com/project/10000" />
          <QRCode value="https://vmap.example.com/project/10000?render=svg" type="svg" />
          <QRCode value="https://vmap.example.com/project/10000?borderless=1" :bordered="false" />
        </div>
      </div>
      ...
      <div class="grid gap-2 md:grid-cols-[88px_minmax(0,1fr)] md:items-center">
        ...
        <div class="flex flex-wrap items-center gap-4 rounded-md bg-secondary/60 px-3 py-4">
          <QRCode value="https://vmap.example.com/project/brand" color="#1677ff" bg-color="#f0f7ff" :margin-size="2" />
          <QRCode value="https://vmap.example.com/project/icon" icon="/favicon.ico" :icon-size="36" error-level="H" :margin-size="2" />
          <QRCode value="https://vmap.example.com/project/large" :size="192" icon="/favicon.ico" :icon-size="{ width: 44, height: 44 }" error-level="H" />
        </div>
      </div>
      ...
      <div class="grid gap-2 md:grid-cols-[88px_minmax(0,1fr)] md:items-center">
        ...
        <div class="flex flex-wrap items-center gap-4 rounded-md bg-secondary/60 px-3 py-4">
          <QRCode value="https://vmap.example.com/project/loading" status="loading" />
          <QRCode value="https://vmap.example.com/project/expired" status="expired" @refresh="lastRefresh = '已触发刷新'" />
          <QRCode value="https://vmap.example.com/project/scanned" status="scanned" />
      ...
      <div class="grid gap-2 md:grid-cols-[88px_minmax(0,1fr)] md:items-start">
        ...
        <div class="flex flex-wrap items-center gap-4 rounded-md bg-secondary/60 px-3 py-4">
          <QRCode value="https://vmap.example.com/project/custom-status" status="expired" :status-render="renderCustomStatus" />
          <QRCode value="https://vmap.example.com/project/slot-status" status="scanned">
